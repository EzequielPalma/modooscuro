...
export default function Home() {
  ...
  const [lightModeButton, setLightModeButton ] = useState("show");

  const [darkModeButton, setDarkModeButton ] = useState("hidden");
  ...
  <main className={`${darkMode} flex min-h-screen flex-col items-center justify-between p-24`}>
      ...
      <img src='https://t2.gstatic.com/licensed-image?q=tbn:ANd9GcQOO0X7mMnoYz-e9Zdc6Pe6Wz7Ow1DcvhEiaex5aSv6QJDoCtcooqA7UUbjrphvjlIc'></img>
